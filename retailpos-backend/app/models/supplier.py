"""RG_Supplier – exact RTGW columns."""
...
class Supplier(Base):
    ...
    supplier_code: Mapped[Optional[str]] = mapped_column(
        "SupplierCode", String(20), nullable=True
    )
    supplier_name: Mapped[str] = mapped_column(
        "SupplierName", String(150), nullable=False
    )
    mobile_no: Mapped[Optional[str]] = mapped_column(
        "MobileNo", String(15), nullable=True
    )
    ...
    gst_no: Mapped[str] = mapped_column(
        "GSTNo", String(20), nullable=False, default=""
    )